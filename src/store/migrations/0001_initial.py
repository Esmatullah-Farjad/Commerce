    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('package_sale_price', models.IntegerField(default=0, null=True)),
                ('item_sale_price', models.IntegerField(default=0, null=True)),
